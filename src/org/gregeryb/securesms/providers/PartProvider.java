...
import org.gregeryb.securesms.mms.PartUriParser;
import org.gregeryb.securesms.service.KeyCachingService;
import org.gregeryb.securesms.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.gregeryb.provider.securesms/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.gregeryb.provider.securesms", "part/*/#", SINGLE_ROW);
  }

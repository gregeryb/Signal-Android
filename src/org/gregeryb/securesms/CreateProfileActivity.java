...
import org.gregeryb.securesms.profiles.ProfileMediaConstraints;
import org.gregeryb.securesms.profiles.SystemProfileUtil;
...
import org.gregeryb.securesms.util.FileProviderUtil;
import org.gregeryb.securesms.util.IntentUtils;
...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("org.gregeryb.securesms.action.CLEAR_PROFILE_PHOTO"));
    }

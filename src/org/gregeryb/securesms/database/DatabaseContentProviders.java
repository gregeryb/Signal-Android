...
public class DatabaseContentProviders {
  ...
  public static class ConversationList extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://org.gregeryb.securesms.database.conversationlist");
  }

  public static class Conversation extends NoopContentProvider {
    private static final String CONTENT_URI_STRING = "content://org.gregeryb.securesms.database.conversation/";
  ...
  public static class Attachment extends NoopContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://org.gregeryb.securesms.database.attachment");
  }

...
import org.gregeryb.securesms.attachments.MmsNotificationAttachment;
import org.gregeryb.securesms.contactshare.Contact;
import org.gregeryb.securesms.database.documents.IdentityKeyMismatch;
import org.gregeryb.securesms.database.documents.IdentityKeyMismatchList;
import org.gregeryb.securesms.database.documents.NetworkFailure;
import org.gregeryb.securesms.database.documents.NetworkFailureList;
import org.gregeryb.securesms.database.helpers.SQLCipherOpenHelper;
import org.gregeryb.securesms.database.model.MediaMmsMessageRecord;
import org.gregeryb.securesms.database.model.MessageRecord;
import org.gregeryb.securesms.database.model.NotificationMmsMessageRecord;
import org.gregeryb.securesms.database.model.Quote;
import org.gregeryb.securesms.jobmanager.JobManager;
import org.gregeryb.securesms.jobs.TrimThreadJob;
import org.gregeryb.securesms.logging.Log;
import org.gregeryb.securesms.mms.IncomingMediaMessage;
...
import org.gregeryb.securesms.util.JsonUtils;
...
import static org.gregeryb.securesms.contactshare.Contact.Avatar;
import static org.gregeryb.securesms.contactshare.Contact.deserialize;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.gregeryb.securesms.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.gregeryb.securesms.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.gregeryb.securesms.util.Util.toIsoBytes(transactionId);

...
import org.gregeryb.securesms.database.model.SmsMessageRecord;
...
import org.gregeryb.securesms.sms.IncomingGroupMessage;
...
public class SmsDatabase extends MessagingDatabase {
  ...
  protected Optional<InsertResult> insertMessageInbox(IncomingTextMessage message, long type) {
    ...
    boolean    unread     = (org.gregeryb.securesms.util.Util.isDefaultSmsProvider(context) ||

...
import org.gregeryb.securesms.push.IasTrustStore;
import org.gregeryb.securesms.recipients.Recipient;
import org.gregeryb.securesms.sms.IncomingJoinedMessage;
import org.gregeryb.securesms.util.concurrent.SignalExecutors;
...
public class DirectoryHelper {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("org.gregeryb.securesms");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "org.gregeryb.securesms");
